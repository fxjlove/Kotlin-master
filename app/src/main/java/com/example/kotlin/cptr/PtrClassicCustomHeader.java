...
public class PtrClassicCustomHeader extends FrameLayout implements PtrUIHandler {
    ...
    private LinearLayout mLlPtrCustomHeader;
    ...
    public PtrClassicCustomHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.support_cube_ptr_classic_custom_header, this);

        mLlPtrCustomHeader = (LinearLayout) header.findViewById(R.id.ll_ptr_custom_header);
    ...
    public LinearLayout getmLlPtrCustomHeader() {
        return mLlPtrCustomHeader;
    }
