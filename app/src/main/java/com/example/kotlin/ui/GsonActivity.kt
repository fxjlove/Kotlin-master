...
import com.example.kotlin.bean.gson.PushRespBean1
...
class GsonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_01.setOnClickListener {
            val data1 =
                "{\"isEncrypt\":\"true\",\"data\":{\"msgId\":\"2019102401000000002\",\"providerMsgId\":\"\",\"fromSystem\":\"MOT\",\"msgDetailType\":\"1\",\"msgType\":\"NS\",\"showType\":\"0\",\"body\":\"测试信息\",\"bodyFormat\":\"1\",\"title\":\"测试信息\",\"pubTime\":\"2019-10-24 10:39:58\",\"fromIdType\":\"\",\"fromId\":\"\",\"destIdType\":\"employee\",\"destId\":\"012136\",\"priority\":3,\"linkUrl\":\"1\",\"summary\":\"1\"}}"
            val data = """
            ...
            val gson = Gson()
//            val bean = gson.fromJson(data, PushRespBean::class.javaObjectType)
            val bean = Gson().fromJson(data, PushRespBean1::class.javaObjectType)

            var push = bean.push
            Log.e("fxj", "name:" + push?.title)
